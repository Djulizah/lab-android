...
public class RvAdapter extends RecyclerView.Adapter<RvAdapter.ViewHolder> {
    ...
    public RvAdapter (List<Upload> listPost) {
...
//    }
    ...
    public void onBindViewHolder(@NonNull RvAdapter.ViewHolder holder, int position) {
        ...
        holder.iv_profile.setImageResource(upload.getUser().getImageUrl());
        holder.tv_fullname.setText(upload.getUser().getFullName());
        holder.tv_username.setText(upload.getUser().getUserName());
        holder.tv_uname.setText(upload.getUser().getUserName());

        holder.iv_profile.setOnClickListener(v->{
            Intent intent = new Intent(holder.itemView.getContext(), ProfileActivity.class);
            intent.putExtra("user", upload.getUser());
